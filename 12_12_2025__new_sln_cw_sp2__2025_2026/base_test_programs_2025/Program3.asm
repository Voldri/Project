...
LABEL@WHILE_00007FF7A873B8C8:
    ...
    cmp eax, 0
    jz LABEL@AFTER_WHILE_00007FF7A873B8C8
    ...
    ;end of while
    jmp LABEL@WHILE_00007FF7A873B8C8
LABEL@AFTER_WHILE_00007FF7A873B8C8:
...
LABEL@WHILE_00007FF7A8744A40:
    ...
    ;after cond expresion (after "WHILE")
    cmp eax, 0
    jz LABEL@AFTER_WHILE_00007FF7A8744A40
...
LABEL@WHILE_00007FF7A8748048:
    ...
    ;after cond expresion (after "WHILE")
    cmp eax, 0
    jz LABEL@AFTER_WHILE_00007FF7A8748048
    ...
    ;end of while
    jmp LABEL@WHILE_00007FF7A8748048
LABEL@AFTER_WHILE_00007FF7A8748048:
    ...
    ;end of while
    jmp LABEL@WHILE_00007FF7A8744A40
LABEL@AFTER_WHILE_00007FF7A8744A40:
